...
<div class="container mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="flex">
        ...
        <div class="w-1/4 p-6 bg-white dark:bg-gray-800 shadow-md rounded-lg">
            ...
            <form method="GET" action="{{ route('products.monitors') }}">
                ...
                <thead class="bg-gray-50 dark:bg-gray-700">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                            <a href="{{ route('products.monitors', array_merge(request()->query(), ['sort_by' => 'name', 'order' => request('order') == 'asc' ? 'desc' : 'asc'])) }}">Name</a>
                        </th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                            <a href="{{ route('products.monitors', array_merge(request()->query(), ['sort_by' => 'price', 'order' => request('order') == 'asc' ? 'desc' : 'asc'])) }}">Price</a>
                        </th>
