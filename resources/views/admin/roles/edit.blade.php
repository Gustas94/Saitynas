...
<div class="flex">
    ...
    <div class="w-5/6 p-6 bg-white dark:bg-gray-800 shadow-md rounded-lg">
        <h1 class="text-2xl font-bold mb-6 text-gray-900 dark:text-gray-100">Edit Role</h1>
        ...
        <form method="POST" action="{{ route('admin.roles.update', $role->id) }}">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" id="name" class="w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring focus:ring-opacity-50 focus:ring-blue-500 dark:bg-gray-700 dark:text-gray-200" value="{{ $role->name }}" required>
            </div>
